...
output:
  html_document:
    ...
    toc_float: true
---
# Main network model diagnostics - balanced
This file shows diagnostics for the main network model fit using balanced racial/ethnic mixing matrices and degree terms adjusted to correspond to the balanced mixing matrices.
...
load(file = "/homes/dpwhite/R/GitHub Repos/WHAMP/Model fits and simulations/Fit tests and debugging/est/fit.m.balanced.whamp.rda")
