...
output:
  html_document:
    ...
    toc_float: true
---
# Instantaneous network model diagnostics - balanced statistics with higher netdx MCMC interval
...
### Network diagnostics
```{r}
(dx_inst <- netdx(fit.i, dynamic = FALSE, nsims = 100, ncores = 4, set.control.ergm = control.simulate.ergm(MCMC.interval = 1e+7, MCMC.burnin = 1e+7)))
