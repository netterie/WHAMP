...
prop.raceregion <- prop.table(svytable(~hbo + region, whpp_artnet),2)

deg.mp.KC.adj <- deg.mp.H.adj*prop.raceregion[1,1]+deg.mp.B.adj*prop.raceregion[2,1] + deg.mp.O.adj*prop.raceregion[3,1]

deg.mp.OW.adj <- deg.mp.H.adj*prop.raceregion[1,2]+deg.mp.B.adj*prop.raceregion[2,2] + deg.mp.O.adj*prop.raceregion[3,2]

deg.mp.EW.adj <- deg.mp.H.adj*prop.raceregion[1,3]+deg.mp.B.adj*prop.raceregion[2,3] + deg.mp.O.adj*prop.raceregion[3,3]
...
```{r include=FALSE}
# Save parameters
degree <- list(deg.mp = deg.mp, deg.mp.H = deg.mp.H, deg.mp.B = deg.mp.B, deg.mp.O = deg.mp.O, deg.mp.adj = deg.mp.adj, deg.mp.H.adj = deg.mp.H.adj, deg.mp.B.adj = deg.mp.B.adj, deg.mp.O.adj = deg.mp.O.adj, degm.region = main.dist.region, degp.region = pers.dist.region)
