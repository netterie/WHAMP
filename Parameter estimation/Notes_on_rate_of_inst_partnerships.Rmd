...
ggplot(sample[!is.na(sample$rate_inst),], aes(rate_inst)) + geom_histogram(binwidth = 0.005) + labs(x="Rate of instantaneous partners", title="Distribution of the rate of instantaneous partners")
...
The statistics and plots below explore heterogeneity in the rate of instantaneous partners by momentary degree. 
...
```{r rate_inst_degree}
    ...
    ggplot(sample[!is.na(sample$rate_inst) & !is.na(sample$deg_matrix),], aes(rate_inst)) + geom_histogram(binwidth = 0.005) + facet_grid(deg_matrix~.) + labs(x="Rate of instantaneous partnerships", title="Rate of instantaneous partnerships by momentary degree") + plot_background + theme_title
```