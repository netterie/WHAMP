...
<span style="color:red>These data show clear imbalances, which we will need to figure out how to address. In ergm.ego, the default is to take the mean for the off-diagonal elements. For the by-hand ("sausage-making") approach to estimating summary statistics, I could take the mean, take the lower end estimates of mixing, or take the higher end estimates off the diagonal. This coudl be something to explore in sensitivity analyses </span>