...
```{r racemixing}
    racemix_main <- table(sample_reweighted$race_eth_m[sample_reweighted$mrp_race_eth_m!="Dont know" & sample_reweighted$mrp_type_ongoing %in% "Main"], sample_reweighted$mrp_race_eth_m[sample_reweighted$mrp_race_eth_m!="Dont know" & sample_reweighted$mrp_type_ongoing %in% "Main"])
 racemix_pers <- table(sample_reweighted$race_eth_m[sample_reweighted$mrp_race_eth_m!="Dont know" & sample_reweighted$mrp_type_ongoing %in% "Persistent"], sample_reweighted$mrp_race_eth_m[sample_reweighted$mrp_race_eth_m!="Dont know" & sample_reweighted$mrp_type_ongoing %in% "Persistent"])
 racemix_inst <- table(sample_reweighted$race_eth_m[sample_reweighted$mrp_race_eth_m!="Dont know" & sample_reweighted$mrp_type_r %in% "One time"], sample_reweighted$mrp_race_eth_m[sample_reweighted$mrp_race_eth_m!="Dont know" & sample_reweighted$mrp_type_r %in% "One time"])
...
```{r agemixing}
    sample_reweighted$age_cat_crude <- cut(sample_reweighted$age, c(17, 24, 34, 44, 59), labels=c("18-24", "25-34", "35-44", "45-59"))
    sample_reweighted$mrp_age_cat_crude <- cut(sample_reweighted$mrp_ageinyears_approx, c(17, 24, 34, 44, 59), labels=c("18-24", "25-34", "35-44", "45-59"))    

    agemix_main <- table(sample_reweighted$age_cat_crude[sample_reweighted$mrp_type_ongoing %in% "Main"], sample_reweighted$mrp_age_cat_crude[sample_reweighted$mrp_type_ongoing %in% "Main"])
    agemix_pers <- table(sample_reweighted$age_cat_crude[sample_reweighted$mrp_type_ongoing %in% "Persistent"], sample_reweighted$mrp_age_cat_crude[sample_reweighted$mrp_type_ongoing %in% "Persistent"])
    agemix_inst <- table(sample_reweighted$age_cat_crude[sample_reweighted$mrp_type_r %in% "One time"], sample_reweighted$mrp_age_cat_crude[sample_reweighted$mrp_type_r %in% "One time"])
