...
If we take the averages of the off-diagonal elements, the mixing matrices are as follows. Due to the small cell count for black men, we will compare the averages based on data from ongoing partnerships only (for main and persistent partnerships) to the averages based on data from all partnerships reported as the most recent partner to decide whether it would be better to sue data from all partnerships.
