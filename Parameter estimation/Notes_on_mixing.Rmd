...
```{r racemixing}
    racemix_main <- table(reweight_ps_rake$race_eth_m[reweight_ps_rake$mrp_race_eth_m!="Dont know" & reweight_ps_rake$mrp_type_ongoing %in% "Main"], reweight_ps_rake$mrp_race_eth_m[reweight_ps_rake$mrp_race_eth_m!="Dont know" & reweight_ps_rake$mrp_type_ongoing %in% "Main"])
 racemix_pers <- table(reweight_ps_rake$race_eth_m[reweight_ps_rake$mrp_race_eth_m!="Dont know" & reweight_ps_rake$mrp_type_ongoing %in% "Persistent"], reweight_ps_rake$mrp_race_eth_m[reweight_ps_rake$mrp_race_eth_m!="Dont know" & reweight_ps_rake$mrp_type_ongoing %in% "Persistent"])
 racemix_inst <- table(reweight_ps_rake$race_eth_m[reweight_ps_rake$mrp_race_eth_m!="Dont know" & reweight_ps_rake$mrp_type_r %in% "One time"], reweight_ps_rake$mrp_race_eth_m[reweight_ps_rake$mrp_race_eth_m!="Dont know" & reweight_ps_rake$mrp_type_r %in% "One time"])
...
```{r agemixing}
    reweight_ps_rake$age_cat_crude <- cut(reweight_ps_rake$age, c(17, 24, 34, 44, 59), labels=c("18-24", "25-34", "35-44", "45-59"))
    reweight_ps_rake$mrp_age_cat_crude <- cut(reweight_ps_rake$mrp_ageinyears_approx, c(17, 24, 34, 44, 59), labels=c("18-24", "25-34", "35-44", "45-59"))    

    agemix_main <- table(reweight_ps_rake$age_cat_crude[reweight_ps_rake$mrp_type_ongoing %in% "Main"], reweight_ps_rake$mrp_age_cat_crude[reweight_ps_rake$mrp_type_ongoing %in% "Main"])
    agemix_pers <- table(reweight_ps_rake$age_cat_crude[reweight_ps_rake$mrp_type_ongoing %in% "Persistent"], reweight_ps_rake$mrp_age_cat_crude[reweight_ps_rake$mrp_type_ongoing %in% "Persistent"])
    agemix_inst <- table(reweight_ps_rake$age_cat_crude[reweight_ps_rake$mrp_type_r %in% "One time"], reweight_ps_rake$mrp_age_cat_crude[reweight_ps_rake$mrp_type_r %in% "One time"])
