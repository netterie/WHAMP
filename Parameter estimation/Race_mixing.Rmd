...
```{r}
prop.hom.main <- cbind.data.frame("Method" = c("Unbalanced", "Balanced"), "Hispanic" = c(racemix_main_rwt[1,1]/sum(racemix_main_rwt[1,]), racemix_main_bal[1,1]/sum(racemix_main_bal[1,])), "Black" = c(racemix_main_rwt[2,2]/sum(racemix_main_rwt[2,]), racemix_main_bal[2,2]/sum(racemix_main_bal[2,])), "Other" = c(racemix_main_rwt[3,3]/sum(racemix_main_rwt[3,]), racemix_main_bal[3,3]/sum(racemix_main_bal[3,])))
...
```{r}
prop.hom.pers <- cbind.data.frame("Method" = c("Unbalanced", "Balanced"), "Hispanic" = c(racemix_pers_rwt[1,1]/sum(racemix_pers_rwt[1,]), racemix_pers_bal[1,1]/sum(racemix_pers_bal[1,])), "Black" = c(racemix_pers_rwt[2,2]/sum(racemix_pers_rwt[2,]), racemix_pers_bal[2,2]/sum(racemix_pers_bal[2,])), "Other" = c(racemix_pers_rwt[3,3]/sum(racemix_pers_rwt[3,]), racemix_pers_bal[3,3]/sum(racemix_pers_bal[3,])))
