...
# Merge ART-Net and WHPP datasets with the relevant variables
    ...
    neg1 <- neg %>% select(pid, degree_main, degreecat_cas, region, hbo, age, hiv, mrp_type_ongoing, mrp_type, mrp_ageinyrs, mrp_hivpos, pship_age, position_cat, weight)
    ...
    pos1 <- pos %>% select(pid, degree_main, degreecat_cas, region, hbo, age, hiv, mrp_type_ongoing, mrp_type, mrp_ageinyrs, mrp_hivpos, pship_age, position_cat, weight)
