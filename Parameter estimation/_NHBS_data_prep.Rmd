...
#-----------------------------------------------------------------------------------
  ...
  nhbs2014 <- read.csv("/homes/dpwhite/win/project/MMP_WADOH/NHBS MMP4 2014/NHBS MSM4 de-identified data set with cdc weights.csv", header=TRUE, sep=",", na.strings = c("NA", "", "."))
...
save(nhbs2014, file="/homes/dpwhite/win/project/MMP_WADOH/nhbs2014_unweighted.Rdata")
save(nhbs_svy_agecap, file="/homes/dpwhite/win/project/MMP_WADOH/nhbs_agecap.Rdata")
