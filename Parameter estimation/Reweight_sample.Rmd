...
#Race and region
    ...
    #HIV-negative only
    pop.raceregion.neg <- cbind.data.frame(region=c(rep("King County", 3), rep("Western WA", 3), rep("Eastern WA", 3)), hbo=c(rep(c("Hispanic", "Black", "Other"), 3)), Freq=c(pop.raceregion.all[1:3, 3] - pop.raceregion.pos[1:3, 3], pop.raceregion.all[4:6, 3] - pop.raceregion.pos[4:6, 3], pop.raceregion.all[7:9, 3] - pop.raceregion.pos[7:9, 3]))
...
#Age
    ...
    #HIV-negative only
    pop.age.neg <- cbind.data.frame(age_cat_alt = c("18-24", "25-29", "30-34", "35-39", "40-49", "50-59"), Freq = c(pop.age.all$Freq - pop.age.pos$Freq))
