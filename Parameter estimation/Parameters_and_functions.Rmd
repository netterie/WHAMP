...
# Add rows for each parameter
 ...
 #Network composition
  ...
  parameters <- param_table(parameters, "deg.m.region", "Main degree distribution by region (EW, KC, OW)", paste(as.vector(t(round(degree$degm.region$proportion, 4))), collapse=", "), NA, "WHPP survey, assumed to apply to HIV-negative and HIV-positive MSM")
  parameters <- param_table(parameters, "deg.p.region", "Persistent degree distribution by region (EW, KC, OW)", paste(as.vector(t(round(degree$degp.region$proportion, 4))), collapse=", "), NA, "WHPP survey, assumed to apply to HIV-negative and HIV-positive MSM")
