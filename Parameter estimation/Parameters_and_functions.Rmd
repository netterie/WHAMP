...
# Add rows for each parameter
 ...
 #Network composition
  ...
  parameters <- param_table(parameters, "agestr", "Proportion of the population in each age group 18-24 through 50-59", paste(round(prop.table(svytable(~age_cat, sample_rake_all, round=FALSE)),4), collapse=", "), NA, "2011-2015 American Community Survey (ACS) 5-year estimates [@WA-census] and estimates of the size of the MSM population by county [@Grey2016]")
