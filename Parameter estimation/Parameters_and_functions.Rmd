...
# Add rows for each parameter
 ...
 #Network composition
  ...
  parameters <- param_table(parameters, "prop.deg.p.EW", "Proportion of men with degree 0, 1, and 2+ who live in eastern Washington. Base values based on observed data, alternate values based on weighted avg of racial/ethnic degree.", paste(as.vector(t(round(degree$degp.region$proportion[c(1,4,7)], 4))), collapse=", "), paste(as.vector(t(round(degree$degp.region.adj$proportion[c(1,4,7)], 4))), collapse=", "), "WHPP survey, assumed to apply to HIV-negative and HIV-positive MSM")
  parameters <- param_table(parameters, "prop.deg.p.KC", "Proportion of men with degree 0, 1, and 2+ who live in King County. Base values based on observed data, alternate values based on weighted avg of racial/ethnic degree.", paste(as.vector(t(round(degree$degp.region$proportion[c(2,5,8)], 4))), collapse=", "), paste(as.vector(t(round(degree$degp.region.adj$proportion[c(2,5,8)], 4))), collapse=", "), "WHPP survey, assumed to apply to HIV-negative and HIV-positive MSM")
  parameters <- param_table(parameters, "prop.deg.p.OW", "Proportion of men with degree 0, 1, and 2+ who live in western Washington. Base values based on observed data, alternate values based on weighted avg of racial/ethnic degree.", paste(as.vector(t(round(degree$degp.region$proportion[c(3,6,9)], 4))), collapse=", "), paste(as.vector(t(round(degree$degp.region.adj$proportion[c(3,6,9)], 4))), collapse=", "), "WHPP survey, assumed to apply to HIV-negative and HIV-positive MSM")
  ...
  parameters <- param_table(parameters, "inst.region", "Distribution of instantaneous partnerships by region (EW, KC, OW). Base values based on observed data, alternate values based on weighted avg of racial/ethnic rates",  paste(round(inst.dist.region$proportion, 4), collapse=", "), paste(round(inst.dist.region_adj$proportion, 4), collapse=", "), "WHPP survey, assumed to apply to HIV-negative and HIV-positive MSM")
