...
# Add rows for each parameter
 ...
 #Network composition
  ...
  parameters <- param_table(parameters, "deg.m.region", "Main degree distribution by region (EW, KC, OW). Base values based on weighted avg of racial/ethnic degree, alternate values based on observed data.", paste(as.vector(t(round(degree$degm.region.adj$proportion, 4))), collapse=", "), paste(as.vector(t(round(degree$degm.region$proportion, 4))), collapse=", "), "WHPP survey, assumed to apply to HIV-negative and HIV-positive MSM")
  parameters <- param_table(parameters, "deg.p.region", "Persistent degree distribution by region (EW, KC, OW). Base values based on weighted avg of racial/ethnic degree, alternate values based on observed data.", paste(as.vector(t(round(degree$degp.region.adj$proportion, 4))), collapse=", "), paste(as.vector(t(round(degree$degp.region$proportion, 4))), collapse=", "), "WHPP survey, assumed to apply to HIV-negative and HIV-positive MSM")
