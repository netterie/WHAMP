...
As with age, we lack population-based data on the racial/ethnic distribution of the MSM population in Washington, so we assume the distribution of all males in Washington corresponds to the distribution of MSM. Because the regions in Washington are demographically diverse, we will represent the distribution separately in each region. Table \@ref(tab:racebyregion) presents the racial/ethnic distribution of all MSM, approximated based on the distribution of all males aged 18-59 recorded in the 2011-2015 ACS [@WA-census], as well as the distribution separately by HIV status. The racial/ethnic distribution of diagnosed HIV-positive MSM is based on 2016 data on MSM living with HIV/AIDS in Washington. We calculated the racial/ethnic distribution of HIV-negative and unknown status MSM by applying the estimated percent of males who are MSM in each region [@Grey2016] to ACS population data for each region, and subtracted the number of MSM living with HIV/AIDS. This assumes that the proportion of males who are MSM is the same across racial/ethnic groups. Table \@ref(tab:racebyregion) presents the resulting racial/ethnic distributions for all MSM, HIV-negative or unknown status MSM, and MSM living with diagnosed HIV/AIDS.
