...
```{r region_compare}
    ...
    #Combine columns
    region <- cbind.data.frame("Region" = sample_region$region,  "Census" = (census_region_neg$percent), "Sample" = (sample_region$percent), "Grey et al." = c(MSMbyregion$percentMSM))
