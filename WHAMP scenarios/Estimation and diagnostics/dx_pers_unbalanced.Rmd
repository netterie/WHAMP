...
output:
  html_document:
    ...
    toc_float: true
---
# Persistent network model diagnostics - unbalanced
This file shows diagnostics for the persistent network model fit using unbalanced racial/ethnic mixing matrices and degree terms based on reported data.
...
load(file = "/homes/dpwhite/R/GitHub Repos/WHAMP/WHAMP scenarios/est/fit.p.unbalanced.whamp.rda")
