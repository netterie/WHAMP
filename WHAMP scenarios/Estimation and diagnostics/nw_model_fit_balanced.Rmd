...
# Fit models
  ...
  formation.m <- ~edges +
    ...
    fit.m <- netest(nw.main,
                    ...
                    set.control.ergm = control.ergm(MCMC.interval = 1e+5,                                                                           MCMC.samplesize=7500,
                                                    MCMC.burnin = 1e+6,
    ...
    save(fit.m.bal, file = "/homes/dpwhite/R/GitHub Repos/WHAMP/WHAMP scenarios/est/fit.m.whamp.balanced.rda")

    ```   
    
```{r fit.pers, message = FALSE}      
  ## 2. Persistent Model ---------------------------------------------------------
    ...
    save(fit.p.bal, file = "/homes/dpwhite/R/GitHub Repos/WHAMP/WHAMP scenarios/est/fit.m.whamp.balanced.rda")
```

```{r fit.inst, message = FALSE} 
  ## Fit inst model ----------------------------------------------------------
