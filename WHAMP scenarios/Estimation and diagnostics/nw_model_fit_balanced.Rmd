...
# Fit models
  ...
  formation.m <- ~edges +
    ...
    save(fit.m, file = "/homes/dpwhite/R/GitHub Repos/WHAMP/WHAMP scenarios/est/fit.m.whamp.balanced.rda")
...
```{r fit.pers, message = FALSE}      
  ## 2. Persistent Model ---------------------------------------------------------
    ...
    save(fit.p, file = "/homes/dpwhite/R/GitHub Repos/WHAMP/WHAMP scenarios/est/fit.m.whamp.balanced.rda")
```
